      ...
      const [leadsRes, sitesRes, projectsRes] = await Promise.all([
        ...
        supabase
          ...
          .select(
            ...
            project_products(id, quantity, dynamic_params, product:product_catalog(id, code, category, cee_config, default_params, is_active, params_schema, kwh_cumac_values:product_kwh_cumac(id, building_type, kwh_cumac_existant_lt_400, kwh_cumac_existant_gte_400, kwh_cumac_neuf_lt_400, kwh_cumac_neuf_gte_400)))`
          )
          .eq("org_id", orgId)
